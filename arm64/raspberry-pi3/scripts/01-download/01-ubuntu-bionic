#!/bin/bash
#
# download ununtu bionic arm64 image for raspberry-pi3

IMAGE=ubuntu-18.04.2-preinstalled-server-arm64+raspi3.img

#http://cdimage.ubuntu.com/releases/bionic/release/ubuntu-18.04.2-preinstalled-server-arm64+raspi3.img.xz
