#!/bin/bash
#
# download raspbian lite buster image for raspberry-pi3

#IMAGE=2019-06-20-raspbian-buster-lite
IMAGE=2019-07-10-raspbian-buster-lite
...
curl -L https://downloads.raspberrypi.org/raspbian_lite/images/raspbian_lite-2019-07-12/$IMAGE.zip.sha256   -o $DIR/$IMAGE.zip.sha256
curl -L https://downloads.raspberrypi.org/raspbian_lite/images/raspbian_lite-2019-07-12/$IMAGE.zip	    -o $DIR/$IMAGE.zip
