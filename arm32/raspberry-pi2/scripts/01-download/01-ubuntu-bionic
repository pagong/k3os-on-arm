#!/bin/bash
#
# download ununtu bionic armhf image for raspberry-pi2

IMAGE=ubuntu-18.04.2-preinstalled-server-armhf+raspi2.img

#http://cdimage.ubuntu.com/releases/bionic/release/ubuntu-18.04.2-preinstalled-server-armhf+raspi2.img.xz
